    ...
    <div ref={containerRef} className="flex-1 flex flex-col gap-20 sm:gap-28 pb-20 overflow-x-hidden w-full max-w-full">
      ...
      <section className="space-y-6 max-w-5xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="pt-6 border-t border-slate-100 flex flex-wrap items-center justify-between gap-3 mt-6">
              ...
              <div className="flex items-center gap-2">
                <Link
                  ...
                  className="px-3 py-2 rounded-full border border-indigo-200 text-indigo-700 bg-indigo-50/50 hover:bg-indigo-100 text-xs font-bold flex items-center gap-1.5 transition-all active:scale-95"
                ...
                <Link
                  to="/c/mithibai-main-campus"
                  className="px-3.5 py-2 rounded-full bg-indigo-600 text-white text-xs font-bold flex items-center gap-1.5 shadow-md hover:bg-indigo-700 transition-all active:scale-95"
                >
                  <span>Menu</span>
          ...
          {/* Card 2: Anand Stall (Fast Food & Juice Centre) */}
          <SpotlightCard className="p-7 shadow-lg shadow-slate-200/40 flex flex-col justify-between group hover:border-orange-500/40 hover:shadow-xl transition-all duration-300">
            <div className="space-y-4">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3.5">
                  <div className="w-12 h-12 rounded-2xl bg-orange-50 text-orange-600 flex items-center justify-center font-bold border border-orange-100">
                    <Flame className="w-6 h-6" />
                  </div>
                  <div>
                    <h3 className="font-black text-lg text-slate-900 leading-tight">Anand Stall</h3>
                    <p className="text-xs text-slate-500">Standalone Diner · Since 1978</p>
                  </div>
                </div>
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Independent food landmark offering 267 dishes: butter vada pavs, Jinny & Matka dosas, gourmet grill sandwiches, and fruit blossoms.
              </p>
              ...
              <div className="flex flex-wrap gap-1.5 pt-1">
                ...
                <span className="px-2.5 py-1 rounded-lg text-[11px] font-semibold bg-orange-50 text-orange-800 border border-orange-200/60">
                  Butter Vada Pav · ₹30
                </span>
            ...
            <div className="pt-6 border-t border-slate-100 flex flex-wrap items-center justify-between gap-3 mt-6">
              ...
              <div className="flex items-center gap-2">
                <Link
                  to="/c/anand-stall/staff/login"
                  className="px-3 py-2 rounded-full border border-orange-200 text-orange-800 bg-orange-50/50 hover:bg-orange-100 text-xs font-bold flex items-center gap-1.5 transition-all active:scale-95"
                  title="Staff & Kitchen Terminal for Anand Stall"
                >
                  <ChefHat className="w-3.5 h-3.5" />
                  <span>Staff</span>
                </Link>
                <Link
                  to="/c/anand-stall"
                  className="px-3.5 py-2 rounded-full bg-orange-600 hover:bg-orange-700 text-white text-xs font-bold flex items-center gap-1.5 shadow-md transition-all active:scale-95"
                >
                  <span>Menu</span>
                  <ArrowRight className="w-3.5 h-3.5" />
                </Link>
          ...
          {/* Card 3: Standalone Gourmet Diner */}
          <SpotlightCard className="p-7 shadow-lg shadow-slate-200/40 flex flex-col justify-between group hover:border-slate-500/40 hover:shadow-xl transition-all duration-300">
            <div className="space-y-4">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3.5">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Standalone diner model with uncluttered UI: routes students straight to fresh gourmet made-to-order dining.
              </p>
            ...
            <div className="pt-6 border-t border-slate-100 flex flex-wrap items-center justify-between gap-3 mt-6">
              ...
              <div className="flex items-center gap-2">
                <Link
                  ...
                  className="px-3 py-2 rounded-full border border-amber-200 text-amber-800 bg-amber-50/50 hover:bg-amber-100 text-xs font-bold flex items-center gap-1.5 transition-all active:scale-95"
                ...
                <Link
                  to="/c/downtown-diner"
                  className="px-3.5 py-2 rounded-full bg-slate-900 text-white text-xs font-bold flex items-center gap-1.5 shadow-md hover:bg-black transition-all active:scale-95"
                >
                  <span>Menu</span>
                  <ArrowRight className="w-3.5 h-3.5" />
                </Link>
